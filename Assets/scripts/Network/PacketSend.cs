...
public class PacketSend
{
    ...
    public static Result Server_nextdialogue()
    {
        using (packet p = new packet((int)ServerPackets.nextdialogue))
        {
...
;
    ...
    public static Result Client_Send_nextdialogue()
    {
