...
public class GameClient : ConnectionManager
{
    ...
    private Dictionary<int, PacketHandle> ClientPacketHandles = new Dictionary<int, PacketHandle>()
        ...
        ,
            { (int)PacketSend.ServerPackets.StartGame, PacketHandles_Method.Client_Handle_StartGame }
        ,
        ...
        ,
            ...
            ,
            { (int)PacketSend.ServerPackets.readfragment, PacketHandles_Method.Client_Handle_readfragment }
        };
